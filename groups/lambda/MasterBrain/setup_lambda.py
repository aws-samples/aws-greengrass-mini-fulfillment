...
def _create_lambda(arn, func_name, lambda_handler, lambda_main,
    ...
    try:
        resp = lamb.create_function(
            ...
            Description="gg-mini-fulfillment function for overall demo flow",
...
if __name__ == "__main__":
    create(
        func_name='MasterBrain',
        lambda_main='master_brain',
        lambda_files=['master_brain.py']
    )
    # update(
    #     func_name='SHMasterBrain',
    #     lambda_main='master_brain',
    #     lambda_files=['master_brain.py']
    # )
